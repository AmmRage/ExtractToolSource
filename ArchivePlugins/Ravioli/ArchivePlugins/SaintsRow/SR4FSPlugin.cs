namespace Ravioli.ArchivePlugins.SaintsRow
{
    ...
    public class SR4FSPlugin : AbstractorArchive
    {
        ...
        {
            return File.Exists(Path.Combine(Path.GetDirectoryName(base.FileName), "SaintsRowIV.exe"));
        }
        ...
        public override string[] DefaultDirectories
        {
            get
            {
                return new List<string> { Path.Combine(SystemSearcher.SteamAppsCommonDirectory, "Saints Row IV") }.ToArray();
            }
        }
