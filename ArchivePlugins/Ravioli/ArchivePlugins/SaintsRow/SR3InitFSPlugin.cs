namespace Ravioli.ArchivePlugins.SaintsRow
{
    ...
    public class SR3InitFSPlugin : AbstractorArchive
    {
        ...
        {
            return File.Exists(Path.Combine(Path.GetDirectoryName(base.FileName), "InitiationStation.exe"));
        }
        ...
        public override string[] DefaultDirectories
        {
            get
            {
                return new List<string> { Path.Combine(SystemSearcher.SteamAppsCommonDirectory, "Saints Row The Third - Initiation Station") }.ToArray();
            }
        }
        ...
        public override string TypeName
        {
            get
            {
                return "Saints Row: The Third - Initiation Station";
            }
        }
    }
}
