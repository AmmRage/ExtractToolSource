namespace Ravioli.ArchivePlugins.SaintsRow
{
    ...
    public class SR3FSPlugin : AbstractorArchive
    {
        ...
        {
            return File.Exists(Path.Combine(Path.GetDirectoryName(base.FileName), "saintsrowthethird.exe"));
        }
        ...
        public override string[] DefaultDirectories
        {
            get
            {
                return new List<string> { Path.Combine(SystemSearcher.SteamAppsCommonDirectory, "Saints Row the Third") }.ToArray();
            }
        }
